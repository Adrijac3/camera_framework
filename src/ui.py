...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dump_button = QtWidgets.QPushButton(self.centralwidget)
        self.dump_button.setGeometry(QtCore.QRect(280, 510, 181, 25))
        self.dump_button.setObjectName("dump parameters")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dump_button.setText(_translate("MainWindow", "Dump Parameters"))
